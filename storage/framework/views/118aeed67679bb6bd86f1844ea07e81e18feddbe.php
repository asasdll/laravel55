        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1">
                    ...
                    <form id="from1" method="POST" action="<?php echo e('register'); ?>" class="signup-form">
...
unset($__errorArgs, $__bag); ?>" name="name"  placeholder="Name" required autocomplete="name" autofocus>
...
$message = $__bag->first($__errorArgs[0]); ?>
                          <span class="invalid-feedback" role="alert">
                            <font color="red"><?php echo e("กรุณากรอก ชื่อ"); ?></font>
                          </span>
                          <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>" name="email" placeholder="E-mail"  required autocomplete="email">
...
$message = $__bag->first($__errorArgs[0]); ?>
                          <span class="invalid-feedback" role="alert">
                            <font color="red"><?php echo e("E-mail ถูกใช้ไปเเล้ว"); ?></font>
                          </span>
                          <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
$message = $__bag->first($__errorArgs[0]); ?>
                          <span class="invalid-feedback" role="alert">
                            <font color="red"><?php echo e("กรุณาใส่ Password ให้ตรงกัน  หรือ อย่างน้อย 8 ตัวอักษร"); ?></font>
                          </span>
                          <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                           ...
                           <select class="form-control form-control <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"  name="status" size="0"  required autocomplete="status">
...
$message = $__bag->first($__errorArgs[0]); ?>
                              <span class="invalid-feedback" role="alert">
                                <font color="red"><?php echo e("กรุณา เลือกลักษณะการใช้งาน"); ?></font>
                              </span>
                              <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="from2" method="POST" action="<?php echo e('login'); ?>" class="signup-form">
...
unset($__errorArgs, $__bag); ?>" name="email"  required autocomplete="email"  placeholder="E-mail">
                          <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                          <span class="invalid-feedback" role="alert">
                            <font color="red"><?php echo e("กรุณาตรวจสอบ E-mail  อีกครั้ง"); ?></font>
                          </span>
                          <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
$message = $__bag->first($__errorArgs[0]); ?>
                          <span class="invalid-feedback" role="alert">
                            <font color="red"><?php echo e("กรุณาตรวจสอบ  Password อีกครั้ง"); ?></font>
                          </span>
                          <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
<?php /**PATH C:\xampp\htdocs\project\laravel\resources\views/auth/index.blade.php ENDPATH**/ ?>